            ...
            {cells.map((day, idx) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex size-8 mx-auto items-center justify-center rounded-md text-sm transition-colors',
                    isSel  && 'bg-primary text-primary-foreground font-semibold shadow-sm',
                    !isSel && isToday  && 'border border-primary/60 text-primary font-semibold',
                    !isSel && !isToday && 'hover:bg-muted text-foreground',
                  )}
                >
                  {day}
                </button>
