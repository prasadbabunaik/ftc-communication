...
// Deleting CONTD-4 / project records is destructive and reserved for the
// national tier — RLDCs may edit their region's data but not delete it.
const DELETE_ROLES = new Set(['ADMIN', 'NLDC']);

export function canEditGridData(role)   { return EDIT_ROLES.has(role); }
export function canDeleteGridData(role) { return DELETE_ROLES.has(role); }
